...
from.views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserPostListView, resume_download, save_user_selection
from. import views
urlpatterns = [
    ...
    path('', views.about, name="blogs-about"),
